          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              {!isLoading && hasFetched && (
                <span className="px-2 py-0.5 bg-blue-100 text-blue-700 rounded-full text-xs font-medium" aria-live="polite">
                  {drugs.length}건
                </span>
              )}
            </div>
        ...
        <div className="p-6 overflow-y-auto max-h-[calc(85vh-76px)]" aria-busy={isLoading}>
          ...
          {!isLoading && !error && hasFetched && drugs.length === 0 && (
            <div className="text-center py-16" role="status">
              <svg className="w-12 h-12 text-gray-200 mx-auto mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
